...
import { Users, Target, Building2, Heart, BookOpen, Award, Users2, Handshake, TrendingUp, Star } from 'lucide-react';
        ...
        <div className="container mx-auto px-3 sm:px-5 lg:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <div className="bg-white rounded-lg p-4 lg:p-6 border border-gray-200 shadow-md mb-6">
                {/* Write a division that includes image of the governing body */}
                  <div className="w-full h-full rounded-lg overflow-hidden border border-primary mb-4">
                    <img 
                      src={governingBodyImage} 
                      alt="Governing Body" 
                      className="w-full h-full object-cover"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {values.map((value, index) => (
                    <motion.div
                      ...
                      className="bg-gray-50 rounded-lg p-3 border border-gray-100 hover:border-primary/20 transition-all duration-300"
                    >
              ...
              <div className="relative z-10 p-6 lg:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <h4 className="text-lg font-bold text-white mb-2">Holistic Development</h4>
                  ...
                  <div className="text-center">
                    ...
                    <h4 className="text-lg font-bold text-white mb-2">Collaborative Growth</h4>
                    <p className="text-white/80 text-xs">
