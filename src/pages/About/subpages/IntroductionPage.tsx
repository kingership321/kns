...
import { Building2, Target, Eye, Trophy, UserPlus, Shirt, Users, BookOpen, GraduationCap, Heart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-10 lg:py-16 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={schoolImage}
            alt="Kathmandu National School Campus" 
      ...
      <section className="relative py-10 lg:py-16 bg-gray-50">
        <div className="container mx-auto px-3 sm:px-5 lg:px-6">
          ...
          >
            <div className="bg-gradient-to-r from-red-600/90 to-red-500/80 rounded-lg p-6 lg:p-8 border border-white/20">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-bold text-white font-[Cambria] mb-1.5">Discipline First</h4>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-bold text-white font-[Cambria] mb-1.5">Our Trinity</h4>
                  <p className="text-white/90 text-xs">
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-bold text-white font-[Cambria] mb-1.5">Innovative Teaching</h4>
                  <p className="text-white/90 text-xs">
