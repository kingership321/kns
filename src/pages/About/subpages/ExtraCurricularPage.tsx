    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-6 sm:py-8 lg:py-16 bg-gray-50">
        <div className="container mx-auto px-3 sm:px-4 lg:px-6">
          ...
          {/* Holistic Education Section - Responsive */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-50px" }}
            ...
            <div className="bg-gradient-to-r from-red-600/90 to-red-500/80 rounded-lg p-4 sm:p-6 lg:p-8 border border-white/20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mb-6 sm:mb-8">
                <div className="text-center">
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-white font-[Cambria] mb-1 sm:mb-1.5">Creative Expression</h4>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-white font-[Cambria] mb-1 sm:mb-1.5">Physical Development</h4>
                  <p className="text-white/90 text-xs sm:text-sm">
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-white font-[Cambria] mb-1 sm:mb-1.5">Global Exposure</h4>
                  <p className="text-white/90 text-xs sm:text-sm">
              ...
              <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-white/20">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl font-bold text-white font-[Cambria] mb-1">20+</div>
                    <div className="text-white/90 text-xs sm:text-sm">Activities Offered</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl font-bold text-white font-[Cambria] mb-1">4</div>
                    <div className="text-white/90 text-xs sm:text-sm">Major Categories</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl font-bold text-white font-[Cambria] mb-1">3</div>
                    <div className="text-white/90 text-xs sm:text-sm">Special Programs</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl font-bold text-white font-[Cambria] mb-1">100%</div>
                    <div className="text-white/90 text-xs sm:text-sm">Student Participation</div>
                  </div>
                </div>
              </div>
            </div>
