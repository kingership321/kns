...
import { Folder, ChevronLeft, Image as ImageIcon, Calendar, Clock, MapPin, Users, Search } from 'lucide-react';
      ...
      <section className="relative py-12 lg:py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-6">
          ...
          {selectedEvent ? (
            ...
            >
              {/* Event Header */}
              <div className="bg-gradient-to-r from-primary/90 to-primary/80 rounded-lg p-4 lg:p-6 mb-6 border border-white/20 backdrop-blur-sm">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-3 mb-3">
                      <div className="h-6 w-1 bg-red-500 rounded-full"></div>
                      <h2 className="text-xl lg:text-3xl font-bold text-white font-[Cambria]">
                        {selectedEvent.title}
                      </h2>
                    </div>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-white/90">
                  ...
                  <div className="flex items-center gap-3 mt-3 lg:mt-0">
                    <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-1.5">
                      <div className="flex items-center gap-1 text-white">
                        ...
                        <span className="font-bold text-sm">{selectedEvent.images.length}</span>
                        <span className="text-xs">photos</span>
                      </div>
                    </div>
                    <div className={`px-2 py-1 rounded text-white text-xs font-medium ${getCategoryColor(selectedEvent.category)}`}>
              ...
              <div className="bg-white rounded-lg p-4 lg:p-6 border border-gray-200 shadow-md">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg lg:text-2xl font-bold text-gray-900 font-[Cambria]">
                    Event Details
                  </h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 text-sm mb-1">Highlights</h4>
                      <ul className="space-y-1">
                        <li className="flex items-start gap-2">
                          <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1"></div>
                          <span className="text-gray-700 text-sm">Documented in {selectedEvent.images.length} photographs</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1"></div>
                          <span className="text-gray-700 text-sm">Held at {selectedEvent.location}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1"></div>
                          <span className="text-gray-700 text-sm">Featured {selectedEvent.participants}</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-lg p-4 border border-primary/20">
                      <h4 className="font-bold text-gray-900 text-sm mb-2">Quick Facts</h4>
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600 text-xs">Date:</span>
                          <span className="font-medium text-gray-900 text-sm">{formatDate(selectedEvent.date)}</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600 text-xs">Time:</span>
                          <span className="font-medium text-gray-900 text-sm">{selectedEvent.time}</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600 text-xs">Location:</span>
                          <span className="font-medium text-gray-900 text-sm">{selectedEvent.location}</span>
                        </div>
                        <div className="flex justify-between items-center">
                ...
                <div className="bg-white rounded-lg p-4 lg:p-6 border border-gray-200 shadow-md">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div className="bg-purple-500/5 rounded-lg p-3 border border-purple-500/10">
                      ...
                      <div className="text-gray-600 text-xs">Featured Events</div>
                    </div>
                    <div className="bg-red-500/5 rounded-lg p-3 border border-red-500/10">
                      <div className="text-lg font-bold text-red-600 mb-1">2023</div>
                      <div className="text-gray-600 text-xs">Current Year</div>
                    </div>
                  </div>
                </div>
              </motion.div>
                ...
                {filteredEvents.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    {filteredEvents.map((event, index) => (
                      ...
                      >
                        <div 
                          className="bg-white rounded-lg overflow-hidden border border-gray-200 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer h-full hover:border-1 hover:border-primary/30"
                        ...
                        >
                          ...
                          {/* Accent Border */}
                          <div className="h-1 w-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        </div>
                      </motion.div>
                    ))}
                  </div>
              ...
              >
                <div className="bg-gradient-to-r from-primary/90 to-primary/80 rounded-lg p-6 lg:p-8 border border-white/20">
                  <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 items-center">
                    <div>
                      <h3 className="text-xl lg:text-3xl font-bold text-white font-[Cambria] mb-3">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        <div className="flex items-center gap-1 text-white">
                          ...
                          <span className="text-xs">Click folders to view event photos</span>
                        </div>
                        <div className="flex items-center gap-1 text-white">
                          <div className="w-2 h-2 bg-white rounded-full"></div>
                          <span className="text-xs">Use filters to find specific events</span>
                        </div>
                      </div>
                    </div>
                  </div>
