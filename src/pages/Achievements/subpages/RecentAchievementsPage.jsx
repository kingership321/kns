    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-6 sm:py-8 lg:py-16 bg-gray-50">
        <div className="container mx-auto px-3 sm:px-4 lg:px-6">
          ...
          {/* Global Vision Section - Responsive */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-50px" }}
            ...
            <div className="bg-gradient-to-r from-red-600/90 to-red-500/80 rounded-lg p-4 sm:p-6 lg:p-8 border border-white/20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mb-6 sm:mb-8">
                <div className="text-center">
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-white font-[Cambria] mb-1 sm:mb-1.5">Global Citizenship</h4>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-white font-[Cambria] mb-1 sm:mb-1.5">International Partnerships</h4>
                  <p className="text-white/90 text-xs sm:text-sm">
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-white font-[Cambria] mb-1 sm:mb-1.5">Future Opportunities</h4>
                  <p className="text-white/90 text-xs sm:text-sm">
              ...
              <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-white/20">
                <div className="max-w-3xl mx-auto text-center">
                  <h4 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4 font-[Cambria]">Upcoming International Programs</h4>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
                    <div className="bg-white/10 backdrop-blur-sm rounded-md p-2">
                      <div className="text-white font-bold text-sm sm:text-base mb-0.5">More Exchange Programs</div>
                      <div className="text-white/80 text-xs">Expanding to more countries</div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm rounded-md p-2">
                      <div className="text-white font-bold text-sm sm:text-base mb-0.5">Virtual Exchanges</div>
                      <div className="text-white/80 text-xs">Digital cultural programs</div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm rounded-md p-2">
                      <div className="text-white font-bold text-sm sm:text-base mb-0.5">International Competitions</div>
